...
public interface ClassScheduleRepository extends JpaRepository<ClassSchedule, UUID> {
    ...
    // Conflicto de maestro: mismo día, hora solapada
    @Query("""
    ...
    // Conflicto de salón: mismo día, hora solapada
    @Query("""
        SELECT COUNT(s) FROM ClassSchedule s
    ...
    // Conflicto de alumno: algún alumno del salón tiene otra clase en ese horario
    @Query("""
